...
**当前里程碑**：M2 教练 AI — 代码完成，review 修复中

**M2 进度**：后端 T0-T5 + 前端 T6-T9 全部完成并 push。Code review 发现 2 critical + 3 important 问题，待修复后集成测试。
...
**下一步**：修复 review 发现的 C1/C2/I1/I2/I3 问题 → 集成测试 → M2 关闭
...
| M2 | 教练 AI（核心）：读前指引 → 阅读（笔记+截图问答）→ Q&A（4 种题型+即时反馈+预生成）→ 学习笔记生成 | **代码完成，review 修复中** |
